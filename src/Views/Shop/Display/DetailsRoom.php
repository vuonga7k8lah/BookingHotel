                                            ...
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    <label for="bookRoom_fullName" class="form-label"
                                                           style="font-weight: bold">Họ Và Tên</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="bookRoom_request" class="form-label"
                                                           style="font-weight: bold">Yêu Cầu Đặc Biệt</label>
                                                    <div id="emailHelp" class="form-text">Các yêu cầu đặc biệt không đảm
                                                        bảo sẽ được đáp ứng – tuy nhiên, chỗ nghỉ sẽ cố gắng hết sức để
                                                        thực hiện. Bạn luôn có thể gửi yêu cầu đặc biệt sau khi hoàn tất
                                                        đặt phòng của mình!
                                                    </div>
