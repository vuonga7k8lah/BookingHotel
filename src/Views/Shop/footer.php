        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">Hotel Eternity</h2>
...
<script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrE7C8ROc-lu0ZABllJPpgLu4Az0-0iLg&callback=initMap
"></script>
